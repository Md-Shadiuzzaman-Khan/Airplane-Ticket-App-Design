    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Gap(10),
          Text(hotel['place'], style: Styles.headlineStyle2.copyWith(color: Colors.white70),),
          Text(hotel['destination'], style: Styles.headlineStyle3.copyWith(color: Colors.white),),
          const Gap(8),
          Text('\$${hotel['price']}/Night', style: Styles.headlineStyle1.copyWith(color: Colors.white70),),
        ],
      ),
    );
  }
